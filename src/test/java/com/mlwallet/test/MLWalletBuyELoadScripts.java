...
//    {
//        mlWalletBuyELoad.buyELoadTransactionDetails_BE_TC_01(prop.getproperty("Branch_Verified"),2);
//    }
...
//    {
//        mlWalletBuyELoad.buyELoadWithoutTelecommunicationSelected_BE_TC_04(prop.getproperty("Branch_Verified"), prop.getproperty("SMART"));
//    }
//    @Test(priority = 5)//Pending
//    public void buyELoadInsufficientBalance_BE_TC_05() throws Exception
//    {
//        mlWalletBuyELoad.buyELoadInsufficientBalance_BE_TC_05(prop.getproperty("Branch_Verified"),2);
//    }
...
//        mlWalletBuyELoad.buyELoadNextButtonFunctionalityOnELoadTransactionPage_BE_TC_11(prop.getproperty("Branch_Verified"),prop.getproperty("SMART"),2);
//    }
...
//        mlWalletBuyELoad.buyELoadLoadSelectionPageUIValidation_BE_TC_13(prop.getproperty("Branch_Verified"),2);
//    }
//    @Test(priority = 11)//Pass
//    public void buyELoadLoadSelectionChangeBtnFunctionality_BE_TC_14() throws Exception {
//        mlWalletBuyELoad.buyELoadLoadSelectionChangeBtnFunctionality_BE_TC_14(prop.getproperty("Branch_Verified"),2);
//    }
//    @Test(priority = 12)//Pass
//    public void buyELoadTransactionDetailsPageUIValidation__BE_TC_15() throws Exception {
//        mlWalletBuyELoad.buyELoadTransactionDetailsPageUIValidation_BE_TC_15(prop.getproperty("Branch_Verified"),2);
//    }
...
//        mlWalletBuyELoad.buyELoadPromoConfirmationPopupValidation_BE_TC_24(prop.getproperty("Branch_Verified"),2);
//    }
//
//    @Test(priority = 22)//Pass
//    public void buyELoadOTPPageUIValidation_BE_TC_25() throws Exception {
//        mlWalletBuyELoad.buyELoadOTPPageUIValidation_BE_TC_25(prop.getproperty("Branch_Verified"),2);
//    }
...
//        mlWalletBuyELoad.buyELoadTransactionWithValidMLPin_BE_TC_73(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 31)
//    public void buyELoadTransactionWithInValidMLPin_BE_TC_74() throws Exception {
//        mlWalletBuyELoad.buyELoadTransactionWithInValidMLPin_BE_TC_74(prop.getproperty("Fully_Verified"), 2);
//    }
//
//    @Test(priority = 32)
//    public void buyELoadInOTPPopupValidation_BE_TC_084() throws Exception {
//        mlWalletBuyELoad.buyELoadInOTPPopupValidation_BE_TC_084(prop.getproperty("Branch_Verified"), 2);
//    }
//
//    @Test(priority = 33)
//    public void buyELoadTransactionInAppOTPPopupUIValidation_BE_TC_085() throws Exception {
//        mlWalletBuyELoad.buyELoadTransactionInAppOTPPopupUIValidation_BE_TC_085(prop.getproperty("Branch_Verified"), 2);
//    }
//
//    @Test(priority = 34)
//    public void buyELoadTransactionNewOTPAfterSixtySecondsValidation_BE_TC_086() throws Exception {
//        mlWalletBuyELoad.buyELoadTransactionNewOTPAfterSixtySecondsValidation_BE_TC_086(prop.getproperty("Branch_Verified"), 2);
//    }
//
//    @Test(priority = 35)
//    public void buyELoadTransactionOTPCancelBtnFunctionality_BE_TC_087() throws Exception {
//        mlWalletBuyELoad.buyELoadTransactionOTPCancelBtnFunctionality_BE_TC_087(prop.getproperty("Branch_Verified"), 2);
//    }
//
//    @Test(priority = 36)
//    public void buyELoadTransactionOTPContinueBtnFunctionality_BE_TC_088() throws Exception {
//        mlWalletBuyELoad.buyELoadTransactionOTPContinueBtnFunctionality_BE_TC_088(prop.getproperty("Branch_Verified"), 2);
//    }
//    @Test(priority = 37)
//    public void buyELoadTransactionValidationAfterMinimizingApp_BE_TC_064() throws Exception {
//        mlWalletBuyELoad.buyELoadTransactionValidationAfterMinimizingApp_BE_TC_064(prop.getproperty("Branch_Verified"), 2);
//    }
//
//    @Test(priority = 38)
...
//        mlWalletBuyELoad.buyELoadMaximumLimitForBuyerTierVerifiedTier_BE_TC_48(prop.getproperty("Buyer_Tier"),2);
//    }
    @Test(priority = 45)
...
//        mlWalletBuyELoad.buyELoadMaximumTransactionForBuyerTierVerifiedTier_BE_TC_45(prop.getproperty("Fully_Verified"),2);
//    }
//
//
    @Test(priority = 47)
