...
//			e.printStackTrace();
    ...
    public static WebElement findElement(By byLocator) throws Exception {
        ...
        if (getPlatform().equals("Web")) {
            ...
            return element;
        } else if (getPlatform().equals("Android") || getPlatform().equals("BrowserStack") || getPlatform().equals("iOS") || getPlatform().equals("IOSBrowserStack")) {
...
//			logger.error(e);
    ...
    public static void switchPlatformToWeb(String url) throws InterruptedException {
...
//	}
    ...
    public static boolean scroll_To_Text_Horizontal(By by, String attribute, String text) {
        int a = 0;
        boolean flag = false;
        do {
            List<WebElement> lists = DriverManager.getAppiumDriver().findElements(by);
